		...
		<?php foreach($messages as $message){ ?>
			<tr class="row <?php echo message_classes($message['id']); ?>"
				...
				<td 
					...
					title="<?php e_html( the_message_nick($message['nick']) ); ?>">

					<?php e_html( shorten_nick( the_message_nick($message['nick']) ) ); ?>
				</td>
				...
				<td class="column message-time">
					<a href="#<?php echo $message['id']; ?>" title="<?php e_html( $config->timezone ); ?>">
